...
namespace eshop.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            logger.LogInformation("Users index");
        ...
        {
            logger.LogInformation("Users details");
            if (id == null)
            {
                return NotFound();
            }
        ...
        {
            logger.LogInformation("Users create");
            return View();
        }
        ...
        {
            logger.LogInformation("Users edit");
            if (id == null)
            {
                return NotFound();
            }
        ...
        {
            logger.LogInformation("Users delete");
            if (id == null)
            {
                return NotFound();
            }
        ...
        {
            logger.LogInformation("Users delete confirmed");
            var user = await _context.User.FindAsync(id);
