...
namespace eshop.Areas.Customer.Controllers
{
    ...
    public class CustomerOrderNotCartController : Controller
    {
        ...
        private readonly ILogger<CustomerOrderNotCartController> logger;
        ...
        {
            logger.LogInformation("CustomerOrderNotCart AddOrderItemsToSession");
            double totalPrice = 0;
        ...
        {
            logger.LogInformation("CustomerOrderNotCart ApproveOrderInSession");
            if (HttpContext.Session.IsAvailable)
            {
