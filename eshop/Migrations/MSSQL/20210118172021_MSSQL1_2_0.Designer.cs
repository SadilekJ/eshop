...
namespace eshop.Migrations.MSSQL
{
    ...
    [Migration("20210118172021_MSSQL1_2_0")]
    partial class MSSQL1_2_0
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eshop.Models.Comments.MainComment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("eshop.Models.Comments.SubComment", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("eshop.Models.Product", b =>
                {
                    ...
                    b.Property<string>("DetailOfProduct");
            ...
            modelBuilder.Entity("eshop.Models.Comments.MainComment", b =>
                {
                    b.HasOne("eshop.Models.Product", "Product")
                        .WithOne("MainComments")
                        .HasForeignKey("eshop.Models.Comments.MainComment", "ProductId")
            ...
            modelBuilder.Entity("eshop.Models.Comments.SubComment", b =>
                {
                    b.HasOne("eshop.Models.Comments.MainComment")
